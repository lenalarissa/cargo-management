...
class UnitisedCargoImpl implements UnitisedCargo, CargoInternal {
    ...
    public UnitisedCargoImpl(Customer owner, int storageLocation, Date insertDate, BigDecimal value, HashSet<Hazard> hazards, boolean fragile) {
        this.owner = owner;
