...
class LiquidBulkCargoImpl implements LiquidBulkCargo, CargoInternal {
    ...
    public LiquidBulkCargoImpl(Customer owner, int storageLocation, Date insertDate, BigDecimal value, HashSet<Hazard> hazards, boolean pressurized) {
        this.owner = owner;
