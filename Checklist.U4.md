...
- [x] ausführbar
- [x] CRUD für mindestens einen Frachttyp in der GUI
...
- [x] FXML verwendet
- [x] sortierbare Darstellung der Frachtstücke mit Platz, Kund*in, Inspektionsdatum und Einlagerungsdauer
- [x] skalierbare Darstellung
- [x] data binding verwendet
- [x] Benutzeroberfläche wird nicht gesperrt (Nebenläufigkeit)
