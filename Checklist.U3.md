...
- [x] deterministische Funktionalität testbar
- [x] Simulation 2
- [x] mindestens je ein Test für alle in der Simulation verwendeten Methoden die auf die Geschäftslogik zugreifen
- [x] Simulation 3
